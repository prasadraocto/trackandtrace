...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IWeatherRepository _interface;
        private readonly ApplicationDbContext _context;
        public weatherController(IWeatherRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] WeatherDto model)
        {
