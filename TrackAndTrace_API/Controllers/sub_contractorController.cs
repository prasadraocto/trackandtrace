...
namespace TrackAndTrace_API.Controllers
{
    ...
    [ApiVersion("1.0")]
    public class sub_contractorController : ControllerBase
    {
        private readonly ISubcontractorRepository _interface;
        private readonly ApplicationDbContext _context;
        public sub_contractorController(ISubcontractorRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] SubcontractorDto model)
        {
