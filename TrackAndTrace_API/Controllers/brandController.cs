...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IBrandRepository _interface;
        private readonly ApplicationDbContext _context;
        public brandController(IBrandRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] BrandDto model)
        {
