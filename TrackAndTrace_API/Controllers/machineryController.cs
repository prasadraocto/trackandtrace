...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IMachineryRepository _interface;
        private readonly ApplicationDbContext _context;
        public machineryController(IMachineryRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] MachineryDto model)
        {
