...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IActivityRepository _interface;
        private readonly ApplicationDbContext _context;
        public activityController(IActivityRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] ActivityDto model)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult> GetProjectMappingById(int id)
        {
            APIResponseDTO aPIResponseDTO = new APIResponseDTO();
            ...
            if (token != null)
            {
                aPIResponseDTO = await _interface.GetProjectMappingById(id);
            }
            else
            {
                return Unauthorized();
