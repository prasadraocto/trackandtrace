...
namespace TrackAndTrace_API.Controllers
{
    ...
    [ApiVersion("1.0")]
    public class space_managementController : ControllerBase
    {
        private readonly ISpaceManagementRepository _interface;
        private readonly ApplicationDbContext _context;
        public space_managementController(ISpaceManagementRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] SpaceManagementDto model)
        {
