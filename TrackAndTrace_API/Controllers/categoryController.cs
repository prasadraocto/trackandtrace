...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly ICategoryRepository _interface;
        private readonly ApplicationDbContext _context;
        public categoryController(ICategoryRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] CategoryDto model)
        {
