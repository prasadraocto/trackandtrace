...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly ISub_CategoryRepository _interface;
        private readonly ApplicationDbContext _context;
        public sub_categoryController(ISub_CategoryRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] Sub_CategoryDto model)
        {
