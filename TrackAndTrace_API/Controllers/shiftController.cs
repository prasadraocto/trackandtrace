...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IShiftRepository _interface;
        private readonly ApplicationDbContext _context;
        public shiftController(IShiftRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] ShiftDto model)
        {
