...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly ITaskRepository _interface;
        private readonly ApplicationDbContext _context;
        public taskController(ITaskRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] TaskDto model)
        {
