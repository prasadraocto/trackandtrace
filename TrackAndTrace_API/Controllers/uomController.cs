...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IUOMRepository _interface;
        private readonly ApplicationDbContext _context;
        public uomController(IUOMRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] UOMDto model)
        {
