...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IWarehouseRepository _interface;
        private readonly ApplicationDbContext _context;
        public warehouseController(IWarehouseRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] WarehouseDto model)
        {
