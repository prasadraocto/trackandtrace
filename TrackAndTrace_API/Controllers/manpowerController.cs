...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IManpowerRepository _interface;
        private readonly ApplicationDbContext _context;
        public manpowerController(IManpowerRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] ManpowerDto model)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult> GetManpowerProjectMappingById(int id)
        {
            APIResponseDTO aPIResponseDTO = new APIResponseDTO();
            ...
            if (token != null)
            {
                aPIResponseDTO = await _interface.GetManpowerProjectMappingById(id);
            }
            else
            {
                return Unauthorized();
