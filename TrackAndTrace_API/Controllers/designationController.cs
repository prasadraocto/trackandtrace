...
namespace TrackAndTrace_API.Controllers
{
    ...
    {
        private readonly IDesignationRepository _interface;
        private readonly ApplicationDbContext _context;
        public designationController(IDesignationRepository Interface, ApplicationDbContext context)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Add([FromBody] DesignationDto model)
        {
        ...
        [HttpGet("role_drop_down_list")]
        public async Task<ActionResult> GetRoleDropdownList()
        {
            APIResponseDTO aPIResponseDTO = new APIResponseDTO();
            ...
            if (token != null)
            {
                aPIResponseDTO = await _interface.GetRoleDropdownList();
            }
            else
            {
                return Unauthorized();
