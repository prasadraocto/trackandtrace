CREATE PROCEDURE import_differentiator
    @CompanyID INT,
    @CreatedBy INT,
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Step 3: Check for duplicates in the differentiator table
        ...
        -- Step 5: Insert non-duplicate records into the differentiator table
        INSERT INTO differentiator (
            code,
            name,
            company_id,
            active_flag,
