CREATE PROCEDURE [dbo].[get_material_list]
    @company_id INT,
    @page INT = 1,
    @page_size INT = 10,
...
BEGIN
    ...
    SET @SQL = N'SELECT 
        a.id, a.code, a.name, a.description, a.cost, b.id as uom_id, b.name as uom_name, a.type, a.active_flag
    FROM 
        material a
        INNER JOIN uom b ON a.uom_id = b.id AND b.active_flag = 1 AND b.delete_flag = 0
    WHERE 
